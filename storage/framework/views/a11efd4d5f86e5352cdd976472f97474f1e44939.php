            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="<?php echo e(url('/')); ?>"> <img src="<?php echo e(asset('public/img/logo.png')); ?>" alt="logo"> </a>
                    ...
                    <div class="col-lg-8">
                        <div class="footer_menu">
                            <div class="footer_logo">
                                <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('public/img/logo.png')); ?>" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
...
<?php /**PATH /var/www/html/laravel-products/resources/views/shop/layout.blade.php ENDPATH**/ ?>